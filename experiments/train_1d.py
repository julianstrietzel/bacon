...
p.add_argument(
    ...
    type=float,
    default=5,
    help="The network-equivalent sample rate used to represent the signal. Should be at least twice the Nyquist frequency.",
)
...
def train():
    ...
    fn = dataio.sines1
    train_dataset = dataio.Func1DWrapper(
        range=(-0.5, 0.5), fn=fn, sampling_density=1000, train_every=1000 / 18
    )  # 18 samples is ~1.1 the nyquist rate assuming fmax=8
